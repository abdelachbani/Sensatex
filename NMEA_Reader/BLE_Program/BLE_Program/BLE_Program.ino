...
double TARGET_LAT = 53.291148;
double TARGET_LON = -6.362183;
String currentDestinationName = "Standby";

#define SERVICE_UUID        "4fafc201-1fb5-459e-8fcc-c5c9c331914b"
#define CHARACTERISTIC_UUID "beb5483e-36e1-4688-b7f5-ea07361b26a8"

// Bluetooth message listener
    ...
    void onWrite(BLECharacteristic *pCharacteristic) {
      ...
      if (rxValue.length() > 0) {
        ...
        if (rxValue == "1") {
           TARGET_LAT = 53.2875;
           TARGET_LON = -6.3712;
           currentDestinationName = "Police Station";
        } 
        else if (rxValue == "2") {
           TARGET_LAT = 53.2895;
           TARGET_LON = -6.3768;
        ...
        // More buttons on here
      }
    }
};

void initBLE() {
  BLEDevice::init("Sensatex_Rescue");
  ...
  Serial.println("BLE Started. Starting app...");
}
